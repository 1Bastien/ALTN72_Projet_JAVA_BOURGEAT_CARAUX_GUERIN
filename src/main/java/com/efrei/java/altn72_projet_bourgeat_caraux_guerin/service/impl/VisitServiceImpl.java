...
public class VisitServiceImpl implements VisitService {
    ...
    public List<VisitDTO> getVisitsBySchoolYearId(Long schoolYearId) {
        try {
            ...
            throw new DatabaseException(
                "Une erreur de base de données est survenue lors de la récupération des visites", ex);
        }
    }
    ...
    public VisitDTO createVisit(VisitDTO visitDTO) {
        ...
        try {
            ...
            throw new DatabaseException(
                "Une erreur de base de données est survenue lors de la création de la visite", ex);
        }
    }
    ...
    public VisitDTO updateVisit(Long id, VisitDTO visitDTO) {
        ...
        try {
            ...
            throw new DatabaseException(
                "Une erreur de base de données est survenue lors de la mise à jour de la visite", ex);
        }
    }
    ...
    public void deleteVisit(Long id) {
        ...
        try {
            ...
            throw new DatabaseException(
                "Une erreur de base de données est survenue lors de la suppression de la visite", ex);
        }
    }
}
